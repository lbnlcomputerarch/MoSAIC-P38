...
module tinyMODIN #(
    ...
    // MoSAIC Interface  (SPI gone)   -------------------------------
    input               mem_valid_axi,
    input         [31:0] mem_addr_axi,
    input        [31:0] mem_wdata_axi, 
    input               mem_wstrb_axi, 
    output       [31:0] mem_rdata_axi,
    input             [7:0] rvControl,
    ...
    //----------------------------------------------------------------------------------
	//	ODIN_MOSAIC interface + parameter bank
	//----------------------------------------------------------------------------------
    ...
    ODIN_MOSAIC_CTRL # (
        ...
        .GATE_ACTIVITY(SPI_GATE_ACTIVITY),
        .OPEN_LOOP(SPI_OPEN_LOOP),
        .AER_SRC_CTRL_NNEUR(SPI_AER_SRC_CTRL_nNEUR),
        .MAX_NEUR(SPI_MAX_NEUR)
    );
