...
################################################################
# This is a generated script based on design: memory_ctrl_etc
#
...
# source memory_ctrl_etc_script.tcl
...
set design_name memory_ctrl_etc
...
proc create_root_design { parentCell } {
  ...
  set c0_ddr4_aresetn_0 [ create_bd_port -dir I -type rst c0_ddr4_aresetn_0 ]
  set c0_ddr4_interrupt_0 [ create_bd_port -dir O c0_ddr4_interrupt_0 ]
  set c0_ddr4_ui_clk_0 [ create_bd_port -dir O -type clk c0_ddr4_ui_clk_0 ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {C0_DDR4_S_AXI_0:C0_DDR4_S_AXI_CTRL_0} \
   CONFIG.FREQ_HZ {300000000} \
 ] $c0_ddr4_ui_clk_0
  set_property CONFIG.ASSOCIATED_BUSIF.VALUE_SRC DEFAULT $c0_ddr4_ui_clk_0

  set c0_ddr4_ui_clk_sync_rst_0 [ create_bd_port -dir O -type rst c0_ddr4_ui_clk_sync_rst_0 ]
  set c0_init_calib_complete_0 [ create_bd_port -dir O c0_init_calib_complete_0 ]
  set c0_sys_clk_n_0 [ create_bd_port -dir I -type clk -freq_hz 300000000 c0_sys_clk_n_0 ]
  set c0_sys_clk_p_0 [ create_bd_port -dir I -type clk -freq_hz 300000000 c0_sys_clk_p_0 ]
  ...
  connect_bd_net -net c0_ddr4_aresetn_0_1 [get_bd_ports c0_ddr4_aresetn_0] [get_bd_pins ddr4_0/c0_ddr4_aresetn]
  connect_bd_net -net c0_sys_clk_n_0_1 [get_bd_ports c0_sys_clk_n_0] [get_bd_pins ddr4_0/c0_sys_clk_n]
  connect_bd_net -net c0_sys_clk_p_0_1 [get_bd_ports c0_sys_clk_p_0] [get_bd_pins ddr4_0/c0_sys_clk_p]
  ...
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_ports c0_ddr4_ui_clk_0] [get_bd_pins ddr4_0/c0_ddr4_ui_clk]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk_sync_rst [get_bd_ports c0_ddr4_ui_clk_sync_rst_0] [get_bd_pins ddr4_0/c0_ddr4_ui_clk_sync_rst]
